      ...
      <Card className="w-full max-w-md shadow-xl relative z-10">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full bg-[#0B5B45] hover:bg-[#0D6953] h-11 text-base"
              disabled={isSubmitting}
            >
              {isSubmitting ? (
                <>
          ...
          <div className="mt-6 p-4 bg-[#F4D16B]/10 rounded-lg border border-[#F4D16B]/30">
            <p className="text-sm text-slate-700">
              <span className="font-medium">Note:</span> Your access code provides secure entry to the KidAble Admin Panel. Keep it confidential and don&apos;t share it with others.
            </p>
          </div>
          ...
          <div className="mt-6 text-center space-y-2">
            ...
            <a
              href="mailto:support@kidable.com"
              className="text-sm text-[#0B5B45] hover:underline font-medium"
            >
              Contact Support
            </a>
          </div>
