...
export function TeamParentForm({
  ...
  const canSubmit =
    relationship.trim().length > 0 && ((mode === 'existing' && !!parentId) || (mode === 'new' && fullName.trim().length > 0));
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="flex items-center gap-2 pt-7">
          <Checkbox id="team-parent-primary" checked={primary} onCheckedChange={(checked) => setPrimary(!!checked)} />
