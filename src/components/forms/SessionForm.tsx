...
import { CalendarIcon, Plus, X, GripVertical, Trash2 } from 'lucide-react';
...
export function SessionForm({
  ...
  const addActivity = () => {
    ...
    setFormData({
      ...formData,
      sessionActivities: [...(formData.sessionActivities || []), newActivity],
    });
  };
                ...
                <Popover open={datePickerOpen} onOpenChange={setDatePickerOpen}>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {formData.sessionDate ? formatDate(new Date(formData.sessionDate)) : 'Pick'}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      ...
                      onSelect={(date) => {
                        if (date) {
                          setFormData({ ...formData, sessionDate: date.toISOString().split('T')[0] });
                  ...
                  <div key={index} className="p-4 border rounded-lg bg-card space-y-3">
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Textarea
                          value={activity.antecedent}
                          onChange={(e) => updateActivity(index, 'antecedent', e.target.value)}
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          value={activity.behaviour}
                          onChange={(e) => updateActivity(index, 'behaviour', e.target.value)}
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Textarea
                          value={activity.consequences}
                          onChange={(e) => updateActivity(index, 'consequences', e.target.value)}
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          value={activity.promptType || ''}
                          onValueChange={(value) => updateActivity(index, 'promptType', value)}
                        >
                          <SelectTrigger>
          ...
          <AccordionContent className="space-y-4 pt-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  type="button"
                  onClick={() => addToList('successes', newSuccess, setNewSuccess)}
                  variant="outline"
                  size="icon"
                >
                  <Plus className="size-4" />
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {formData.successes.map((item, index) => (
                    <Badge key={index} variant="secondary" className="gap-1 bg-green-50 text-green-700">
                      ...
                      <button
                        type="button"
                        onClick={() => removeFromList('successes', index)}
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  type="button"
                  onClick={() => addToList('struggles', newStruggle, setNewStruggle)}
                  variant="outline"
                  size="icon"
                >
                  <Plus className="size-4" />
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {formData.struggles.map((item, index) => (
                    <Badge key={index} variant="secondary" className="gap-1 bg-orange-50 text-orange-700">
                      ...
                      <button
                        type="button"
                        onClick={() => removeFromList('struggles', index)}
                        className="ml-1 hover:text-destructive"
                      >
                        <X className="size-3" />
                      </button>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  type="button"
                  onClick={() => addToList('interventionsUsed', newIntervention, setNewIntervention)}
                  variant="outline"
                  size="icon"
                >
                  <Plus className="size-4" />
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {formData.interventionsUsed.map((item, index) => (
                    <Badge key={index} variant="secondary" className="gap-1">
                      ...
                      <button
                        type="button"
                        onClick={() => removeFromList('interventionsUsed', index)}
                        className="ml-1 hover:text-destructive"
                      >
                        <X className="size-3" />
                      </button>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  type="button"
                  onClick={() => addToList('strategiesUsed', newStrategy, setNewStrategy)}
                  variant="outline"
                  size="icon"
                >
                  <Plus className="size-4" />
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {formData.strategiesUsed.map((item, index) => (
                    <Badge key={index} variant="secondary" className="gap-1">
                      ...
                      <button
                        type="button"
                        onClick={() => removeFromList('strategiesUsed', index)}
                        className="ml-1 hover:text-destructive"
                      >
                        <X className="size-3" />
                      </button>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  type="button"
                  onClick={() => addToList('reinforcementTypes', newReinforcement, setNewReinforcement)}
                  variant="outline"
                  size="icon"
                >
                  <Plus className="size-4" />
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {formData.reinforcementTypes.map((item, index) => (
                    <Badge key={index} variant="secondary" className="gap-1">
                      ...
                      <button
                        type="button"
                        onClick={() => removeFromList('reinforcementTypes', index)}
                        className="ml-1 hover:text-destructive"
                      >
                        <X className="size-3" />
                      </button>
          ...
          <AccordionContent className="space-y-4 pt-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  type="button"
                  onClick={() => addToList('sessionTags', newTag, setNewTag)}
                  variant="outline"
                  size="icon"
                >
                  <Plus className="size-4" />
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {formData.sessionTags.map((item, index) => (
                    <Badge key={index} variant="secondary" className="gap-1">
                      ...
                      <button
                        type="button"
                        onClick={() => removeFromList('sessionTags', index)}
                        className="ml-1 hover:text-destructive"
                      >
                        <X className="size-3" />
                      </button>
